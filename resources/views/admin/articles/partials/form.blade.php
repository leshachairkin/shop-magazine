...
<textarea class="form-control" id="description-short" name="description_short">{{$article->description_short ?? ""}}</textarea>
...
<label for="">Мета загаловок</label>
<input type="text" class="form-control" name="meta_title" placeholder="Мета загаловок" value="{{$article->meta_title ?? ""}}">
